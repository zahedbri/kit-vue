<template>
  <div class="overflow-hidden rounded card border-0" :class="$style.carousel">
    <a-carousel>
      <div class="height-150 pt-4 pl-4 overflow-hidden position-relative bg-gray-2 line-height-1 d-block">
